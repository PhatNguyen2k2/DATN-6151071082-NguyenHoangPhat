...
@Entity(name="BOOKING_PERCENT")
public class BookingPercent implements Serializable {

    /** Primary key. */
    protected static final String PK = "bookingPercentId";
    ...
    private BigDecimal bookingPercentId;
    @Column(precision=3)
    ...
    /** Default constructor. */
    public BookingPercent() {
        super();
    }

    /**
     * Access method for bookingPercentId.
     *
     * @return the current value of bookingPercentId
     */
    public BigDecimal getBookingPercentId() {
        return bookingPercentId;
    }

    /**
     * Setter method for bookingPercentId.
     *
     * @param aBookingPercentId the new value for bookingPercentId
     */
    public void setBookingPercentId(BigDecimal aBookingPercentId) {
        bookingPercentId = aBookingPercentId;
    }

    /**
     * Access method for percent.
     *
     * @return the current value of percent
     */
    ...
    /**
     * Setter method for percent.
     *
     * @param aPercent the new value for percent
     */
    ...
    /**
     * Compares the key for this instance with another BookingPercent.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class BookingPercent and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof BookingPercent)) {
            return false;
        }
        BookingPercent that = (BookingPercent) other;
        Object myBookingPercentId = this.getBookingPercentId();
        Object yourBookingPercentId = that.getBookingPercentId();
        if (myBookingPercentId==null ? yourBookingPercentId!=null : !myBookingPercentId.equals(yourBookingPercentId)) {
            return false;
        }
        return true;
    }
    ...
    /**
     * Compares this instance with another BookingPercent.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof BookingPercent)) return false;
        return this.equalKeys(other) && ((BookingPercent)other).equalKeys(this);
    }
    ...
    public int hashCode() {
        int i;
        int result = 17;
        if (getBookingPercentId() == null) {
            i = 0;
        } else {
            i = getBookingPercentId().hashCode();
        }
        result = 37*result + i;
        return result;
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[BookingPercent |");
        sb.append(" bookingPercentId=").append(getBookingPercentId());
        sb.append("]");
        return sb.toString();
    }
    ...
    public Map<String, Object> getPrimaryKey() {
        ...
        ret.put("bookingPercentId", getBookingPercentId());
        return ret;
    }
