...
@Entity(name="DRIVER_RESOURCE")
public class DriverResource implements Serializable {

    /** Primary key. */
    protected static final String PK = "driverResourceId";
    ...
    private BigDecimal driverResourceId;
    @Column(precision=4)
    private BigDecimal driverNumber;
    @Column(precision=10)
    ...
    /**
     * Access method for driverResourceId.
     *
     * @return the current value of driverResourceId
     */
    public BigDecimal getDriverResourceId() {
        return driverResourceId;
    }

    /**
     * Setter method for driverResourceId.
     *
     * @param aDriverResourceId the new value for driverResourceId
     */
    public void setDriverResourceId(BigDecimal aDriverResourceId) {
        driverResourceId = aDriverResourceId;
    }

    /**
     * Access method for driverNumber.
     *
     * @return the current value of driverNumber
     */
    public BigDecimal getDriverNumber() {
        return driverNumber;
    }

    /**
     * Setter method for driverNumber.
     *
     * @param aDriverNumber the new value for driverNumber
     */
    public void setDriverNumber(BigDecimal aDriverNumber) {
        driverNumber = aDriverNumber;
    }
    ...
    /**
     * Compares the key for this instance with another DriverResource.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class DriverResource and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof DriverResource)) {
            return false;
        }
        DriverResource that = (DriverResource) other;
        Object myDriverResourceId = this.getDriverResourceId();
        Object yourDriverResourceId = that.getDriverResourceId();
        if (myDriverResourceId==null ? yourDriverResourceId!=null : !myDriverResourceId.equals(yourDriverResourceId)) {
            return false;
        }
        return true;
    }
    ...
    /**
     * Compares this instance with another DriverResource.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof DriverResource)) return false;
        return this.equalKeys(other) && ((DriverResource)other).equalKeys(this);
    }
    ...
    public int hashCode() {
        int i;
        int result = 17;
        if (getDriverResourceId() == null) {
            i = 0;
        } else {
            i = getDriverResourceId().hashCode();
        }
        result = 37*result + i;
        return result;
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[DriverResource |");
        sb.append(" driverResourceId=").append(getDriverResourceId());
        sb.append("]");
        return sb.toString();
    }
    ...
    public Map<String, Object> getPrimaryKey() {
        ...
        ret.put("driverResourceId", getDriverResourceId());
        return ret;
    }
