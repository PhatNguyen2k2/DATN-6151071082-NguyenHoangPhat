...
public class SpecialRequest implements Serializable {
    ...
    /** Primary key. */
    protected static final String PK = "specialRequestId";
    ...
    private BigDecimal specialRequestId;
    @Column(precision=10)
    ...
    private Order order;
    @ManyToOne
    @JoinColumn(name="specifiedemployeeId")
    private SpecifiedEmployee specifiedEmployee;
    ...
    /**
     * Access method for specialRequestId.
     *
     * @return the current value of specialRequestId
     */
    public BigDecimal getSpecialRequestId() {
        return specialRequestId;
    }

    /**
     * Setter method for specialRequestId.
     *
     * @param aSpecialRequestId the new value for specialRequestId
     */
    public void setSpecialRequestId(BigDecimal aSpecialRequestId) {
        specialRequestId = aSpecialRequestId;
    }
    ...
    /**
     * Access method for specifiedEmployee.
     *
     * @return the current value of specifiedEmployee
     */
    public SpecifiedEmployee getSpecifiedEmployee() {
        return specifiedEmployee;
    }

    /**
     * Setter method for specifiedEmployee.
     *
     * @param aSpecifiedEmployee the new value for specifiedEmployee
     */
    public void setSpecifiedEmployee(SpecifiedEmployee aSpecifiedEmployee) {
        specifiedEmployee = aSpecifiedEmployee;
    }

    /**
     * Compares the key for this instance with another SpecialRequest.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class SpecialRequest and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        ...
        SpecialRequest that = (SpecialRequest) other;
        Object mySpecialRequestId = this.getSpecialRequestId();
        Object yourSpecialRequestId = that.getSpecialRequestId();
        if (mySpecialRequestId==null ? yourSpecialRequestId!=null : !mySpecialRequestId.equals(yourSpecialRequestId)) {
            return false;
        }
        return true;
    }
    ...
    /**
     * Compares this instance with another SpecialRequest.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof SpecialRequest)) return false;
        return this.equalKeys(other) && ((SpecialRequest)other).equalKeys(this);
    }
    ...
    public int hashCode() {
        int i;
        int result = 17;
        if (getSpecialRequestId() == null) {
            i = 0;
        } else {
            i = getSpecialRequestId().hashCode();
        }
        result = 37*result + i;
        return result;
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[SpecialRequest |");
        sb.append(" specialRequestId=").append(getSpecialRequestId());
        sb.append("]");
        return sb.toString();
    }
    ...
    public Map<String, Object> getPrimaryKey() {
        ...
        ret.put("specialRequestId", getSpecialRequestId());
        return ret;
    }
